...
public class Main extends HttpServlet {
  ...
  private void showApplet(HttpServletRequest req, HttpServletResponse resp)
	    ...
	    resp.getWriter().println("<embed code=\"appletTestClass.class\"width=\"300\" height=\"300\"type=\"application/x-java-applet\" pluginspage=\"http://java.sun.com/javase/downloads/ea.jsp\"/>");
  }
